...
class Image19 {
  ...
  constructor() {
    ...
    world.add(new Sphere(new Vector(0, 0, -1), 0.5, new Lambertian(new Vector(0.1, 0.2, 0.5))));
    ...
    world.add(new Sphere(new Vector(1, 0, -1), 0.5, new Metal(new Vector(0.8, 0.6, 0.2), 0.0)));

    const camera = new Camera(aspectRatio, 20.0, new Vector(-2, 2, 1), new Vector(0, 0, -1), new Vector(0, 1, 0));
